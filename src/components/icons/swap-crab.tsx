...
function Swap() {
  return (
    ...
    >
      <title>1.通用/2.Icon图标/Line/Changeicon</title>
      <defs>
        <filter id='filter-1'>
          <feColorMatrix
            in='SourceGraphic'
            type='matrix'
            values='0 0 0 0 0.925490 0 0 0 0 0.215686 0 0 0 0 0.513725 0 0 0 1.000000 0'
          ></feColorMatrix>
        </filter>
      ...
      <g id='DVM' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='其他网络' transform='translate(-216.000000, -194.000000)'>
          <g
            id='1.通用/2.Icon图标/Line/Change'
            transform='translate(215.000000, 191.000000)'
            filter='url(#filter-1)'
          >
            <g>
              <rect
...
export const SwapCrabIcon = svgIconFactory(Swap);
